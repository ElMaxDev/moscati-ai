...
export const metadata: Metadata = {
  title: 'MoscatiAI — El doctor habla, el sistema hace todo lo demás',
  description: 'Copiloto de documentación clínica por voz para el Hospital Moscati',
};
        ...
        <header className="sticky top-0 z-50 bg-white border-b border-primary-100 shadow-sm">
          <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-primary-900">MoscatiAI</h1>
                <p className="text-[10px] text-primary-500 -mt-1">Hospital Moscati</p>
              </div>
            </div>
